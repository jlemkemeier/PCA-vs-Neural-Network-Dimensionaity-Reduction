...
# now calculate the hidden layer output - in this case, let's use a softmax
# activated
# output layer
...
N = 50
x1 = finalpoints[0:50,0]
print(x1)
x2 = finalpoints[50:100,0]
y1 = finalpoints[0:50,1]
y2 = finalpoints[50:100,1]
z1 = finalpoints[0:50,2]
